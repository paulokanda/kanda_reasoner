---
prompt_id: anti_hallucination_full_group
prompt_code: KPR-09-001
title: Evidence Verification Train - Full
version: 2.0.0
status: active
load_type: routed
...
# Evidence Verification Train - Full

## Purpose

Route one sealed operation through the full evidence-verification train.
This group is an orchestrator, not a substitute for the stage prompts.

## Admission

Use this group when the work is consequential, difficult to reverse, cross-box, externally dependent, security-sensitive, or supported by uncertain evidence. Record the operation ID, plan or artifact hash,
