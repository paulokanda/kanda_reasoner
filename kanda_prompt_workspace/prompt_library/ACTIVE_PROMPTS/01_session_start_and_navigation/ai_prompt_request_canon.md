...
zz_read_only_if_modifying_startup_delivery.md - required IF startup delivery, first_prompt_files, source maps, startup naming, startup validation, or paste-after files may be modified.
