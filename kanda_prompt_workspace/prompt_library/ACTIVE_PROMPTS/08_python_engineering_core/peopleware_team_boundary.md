---
prompt_id: A026
canonical_filename: "peopleware_team_boundary.md"
audited_filename: "peopleware_team_boundary.md"
title: "Peopleware Prompt for AI Code Generation"
classification: "SPECIALIST_PROMPT / HUMAN_PROCESS_PROMPT"
decision: "UPDATE"
status: "audited_candidate_after_update"
owns: "human factors, team dynamics, focus protection, burnout prevention, meeting hygiene, async-first collaboration"
does_not_own: "code structure, architecture, deployment, observability, SRE incident mechanics, security implementation"
...
This prompt owns the human and organizational side of software engineering: team focus, interruption control, burnout prevention, meeting design, psychological safety, async-first remote collaboration, and team jelling.

It does not replace technical prompts such as Clean Code, Clean Architecture, Testing, SRE, Observability, or Security. When a problem is primarily human or organizational, use this prompt first. When a problem is primarily technical, use the relevant technical prompt and use Peopleware only as a supporting lens.

When this prompt suggests automation, the automation must be small, respectful, privacy-preserving, and explicitly aimed at reducing toil or interruptions. It must not become employee surveillance.
