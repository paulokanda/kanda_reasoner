...
| 12_generalized_project_canons | 6 | Store generalized reusable project canons, architecture contracts, and desktop help-document layout rules. | When extracting project-agnostic rules from specific projects or creating reusable desktop help-document layout. | Do not place project-specific facts here. |
