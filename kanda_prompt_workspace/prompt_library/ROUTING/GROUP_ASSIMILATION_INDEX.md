...
| 06_refactor_and_architecture_hardening | 8 | Handle large modules, architecture hardening, fragmentation, and roadmap-solving. | When modules are large, risks are architectural, or problem sets need ordering. | Do not use for tiny text edits or simple explanation. |
