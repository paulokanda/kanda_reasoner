"""Build an active source snapshot for one project context bundle."""
...
GENERATOR_NAME = "project_context_bundle.active_snapshot_builder"
...
def build_active_snapshot_payload(project: str | Path | ProjectContext) -> dict[str, Any]:
    ...
    return {
        ...
        "source": {
            "file_manifest_builder": "project_context_bundle.file_manifest_builder",
