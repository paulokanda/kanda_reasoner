"""
Local AI bridge for Project Reasoner V10.
...
--'  FOLDER   : E:/developer_tools/kanda_reasoner_app/project_reasoner_v10/ai_bridge_help              --'
--'                                                      --'
...
from kanda_reasoner_app.project_reasoner_v10.ai_bridge_help.deterministic_answers import (
    answer_deterministic_from_prompt,
    answer_one_line_from_prompt,
    repair_one_line_symbol_ids,
)
from kanda_reasoner_app.project_reasoner_v10.ai_bridge_help.focus_snippets import (
    build_generative_focus_message,
)
from kanda_reasoner_app.project_reasoner_v10.ai_bridge_help.grounding_checks import (
    grounding_failure_reason,
    sanitize_invalid_ids,
)
from kanda_reasoner_app.project_reasoner_v10.ai_bridge_help.prompt_extraction import (
    extract_one_line_triplet,
)
from kanda_reasoner_app.project_reasoner_v10.ai_bridge_help.prompt_modes import (
