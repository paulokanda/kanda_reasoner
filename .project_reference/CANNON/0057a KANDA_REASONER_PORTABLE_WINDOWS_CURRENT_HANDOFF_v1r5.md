...
Feature: `kanda-reasoner-portable-builder-install-v1r5`  
...
```text
PORTABLE BUILDER VERSION: v1r5
PORTABLE BUILDER FEATURE ID: kanda-reasoner-portable-builder-install-v1r5
```
