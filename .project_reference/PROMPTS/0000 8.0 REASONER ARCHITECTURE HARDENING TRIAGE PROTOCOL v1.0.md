# 0000 8.0 REASONER ARCHITECTURE HARDENING TRIAGE PROTOCOL v1.0
...
7. 0000 8.0 REASONER ARCHITECTURE HARDENING TRIAGE PROTOCOL v1.0.md
...
- Use only 0000 4.11.
- Deliver exactly the four active governance files under:
...
- deliver one ZIP
- paths must be project-relative from E:\developer_tools
...
- update only the four governance files
