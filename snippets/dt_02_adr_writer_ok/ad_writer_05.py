# dt_02_adr_writer_ok/ad_writer_05.py
...
def get_user_input() -> str:
    ...
    print(" Enter a short description of your architectural decision (e.g., 'switch to PySide6'):")
    return input(" ").strip()
...
# -------------------------------------------------------
# Step 3 — Attempt a single POST request to the primary API URL.
# -------------------------------------------------------
...
def _post_chat_completion(api_url: str, prompt: str) -> Optional[str]:
    ...
    payload = {
        "model": MODEL,
        "messages": [
            {"role": "system", "content": "You are a software architect documenting design decisions."},
