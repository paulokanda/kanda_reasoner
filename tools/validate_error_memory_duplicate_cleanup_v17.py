# project-path: tools/validate_error_memory_duplicate_cleanup_v17.py
...
FEATURE_ID = "error-memory-duplicate-cleanup-v17"
FILES_UNDER_TEST = [
...
def main() -> int:
    ...
    assert DUPLICATE_CLEANUP_GUARD_VERSION == "v17_single_saved_preserve_selected_duplicate_delete"
