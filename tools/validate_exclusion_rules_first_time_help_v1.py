...
FEATURE_ID = "exclusion-rules-first-time-help-v1"
...
def main() -> int:
    ...
    require("Files, folders, and extensions listed here are treated as not part" in tab,
    ...
    require("fallback rules only" in tab, "Fallback scope text missing.")
