# project-path: tools/engineering_diagnostics_wave2t_validation_runtime.py
"""Focused runtime validation helpers for Engineering Diagnostics Wave 2T."""
...
__all__ = ["run_wave2t_command", "run_wave2t_focused_tests"]
...
def run_wave2t_focused_tests(root: Path) -> None:
    """Run all frozen Engineering Diagnostics tests through Wave 2T."""
    modules = (
    ...
    output = run_wave2t_command(
        ...
        cwd=root,
        markers=("Ran 154 tests", "OK"),
    )
    _require("FAILED" not in output, "WAVE2T_FOCUSED_TEST_FAILURE")
    print("FOCUSED PUBLIC CONTRACT TESTS: 154/154 PASS")
