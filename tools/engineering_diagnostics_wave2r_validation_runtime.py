# project-path: tools/engineering_diagnostics_wave2r_validation_runtime.py
"""Focused runtime validation helpers for Engineering Diagnostics Wave 2R."""
...
__all__ = ["run_wave2r_command", "run_wave2r_focused_tests"]
...
def run_wave2r_focused_tests(root: Path) -> None:
    """Run all frozen Engineering Diagnostics tests through Wave 2R."""
    modules = (
    ...
    output = run_wave2r_command(
        ...
        cwd=root,
        markers=("Ran 125 tests", "OK"),
    )
    _require("FAILED" not in output, "WAVE2R_FOCUSED_TEST_FAILURE")
    print("FOCUSED PUBLIC CONTRACT TESTS: 125/125 PASS")
