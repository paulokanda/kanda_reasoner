# project-path: tools/engineering_diagnostics_wave2v_validation_runtime.py
"""Bounded runtime validation for Engineering Diagnostics Wave 2V."""
...
__all__ = ["run_wave2v_command", "run_wave2v_focused_tests"]
...
def run_wave2v_command(
    ...
    *,
    ...
    """Run one explicit command with the selected Tool root on PYTHONPATH."""
...
def run_wave2v_focused_tests(root: Path) -> None:
    """Run every frozen Diagnostics test through Wave 2V."""
    modules = (
    ...
    output = run_wave2v_command(
        ...
        cwd=root,
        markers=("Ran 180 tests", "OK"),
    )
    _require("FAILED" not in output, "WAVE2V_FOCUSED_TEST_FAILURE")
    print("FOCUSED PUBLIC CONTRACT TESTS: 180/180 PASS")
