"""Real Qt validation for grouped Full Engineering Diagnostics AI handoff v2."""
...
def _run_view(run_id: str, producer: str):
    findings = tuple(_finding(run_id, producer, index) for index in range(80))
    run = NS(
...
class _FakeController:
    ...
    def commit_candidate(self, _project_root, candidate, **_kwargs):
        ...
        return NS(run_id=run_id, finding_count=80)
