# project-path: tools/engineering_diagnostics_wave2u_validation_runtime.py
"""Bounded runtime validation for Engineering Diagnostics Wave 2U."""
...
__all__ = ["run_wave2u_command", "run_wave2u_focused_tests"]
...
def run_wave2u_focused_tests(root: Path) -> None:
    """Run all frozen Engineering Diagnostics tests through Wave 2U."""
    modules = (
    ...
    output = run_wave2u_command(
        ...
        cwd=root,
        markers=("Ran 169 tests", "OK"),
    )
    _require("FAILED" not in output, "WAVE2U_FOCUSED_TEST_FAILURE")
    print("FOCUSED PUBLIC CONTRACT TESTS: 169/169 PASS")
