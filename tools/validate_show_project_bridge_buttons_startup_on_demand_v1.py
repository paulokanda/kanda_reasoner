...
def validate_ui(root: Path) -> None:
    ...
    require(text, 'QColor("#ff4d00")', 'orange button font color')
    require(text, 'QColor("#000000")', 'black Bridges label color')
    ...
    require(text, 'bridges_label_font.setBold(False)', 'Bridges label regular font')
