# project-path: tools/validate_reasoner_tools_gui_colorful_brain_icon_v1r2.py
"""Validate the KANDA Reasoner colorful brain icon and release scripts."""
...
FEATURE_ID = "reasoner-tools-gui-colorful-brain-icon-v1r2"
...
VALIDATOR = Path(
    "tools/validate_reasoner_tools_gui_colorful_brain_icon_v1r2.py"
)
...
def _validate_patch_zip(patch_zip: Path) -> None:
    """Confirm that the patch ZIP carries the corrected cumulative payload."""
    expected = {
    ...
    print("PATCH_ICON_VALIDATOR_REPAIR_PAYLOAD: PASS")


def main() -> int:
    """Run focused source, runtime, asset, Qt, and release checks."""
