...
class T4Q032HBackendInsertionFacadeManifestCompactAllTests(unittest.TestCase):
    """Validate compact static helper exports for insertion facades."""
    ...
    def test_insertion_facades_remain_small(self) -> None:
        for rel_path in TARGETS:
            source = Path(rel_path).read_text(encoding="utf-8")
