...
SOURCE_FILES = [
    ROOT / "kanda_reasoner_app" / "routing_signal_scorer" / "ml_advisory_signal" / "fixture_catalog_contract.py",
    ROOT / "kanda_reasoner_app" / "routing_signal_scorer" / "ml_advisory_signal" / "offline_fixture_catalog.py",
]
...
def test_phase3_source_files_have_no_forbidden_imports_or_calls():
...
def test_phase3_source_files_do_not_create_mlrt_113_or_runtime_terms():
    forbidden = (
        "mlrt_113",
        "mlrt-113",
        "mlrt113",
