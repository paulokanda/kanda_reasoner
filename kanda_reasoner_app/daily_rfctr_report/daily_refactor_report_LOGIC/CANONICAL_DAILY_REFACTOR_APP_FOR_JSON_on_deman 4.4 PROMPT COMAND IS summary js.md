...
engine: daily_refactor_report_engine v12.2
prompt version: 4.4
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CANONICAL JSON STRUCTURE (EXACT MATCH — engine v12.2)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ENGINE v12.2 CONTEXT — WHAT THE APP PRODUCES
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

The engine writes all output into one report folder auto-created under the
user-chosen output folder. The <prefix>_daily_refactor_report.json may
optionally be redirected to a separate user-defined path via the "AI Bundle
Path" field in the UI (Step 2b). The bundle metadata includes both
"report_folder" and "bundle_path" fields to record where each file lives.
...
Output layout:
    ...
    │                                            (may be overridden to another path)
    ...
    │   └── domain_fingerprint.json           ← SHA-256 skip-cache key
    └── archive/
        └── current_state_YYYYMMDD_HHMMSS.json  (capped at 50)

The single file to upload to the AI for full project awareness is:
    <prefix>_daily_refactor_report.json
