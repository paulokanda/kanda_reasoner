# project-path: kanda_reasoner_app/insert_missing_docstrings_gui/insert_missing_docstrings_help/__init__.py
# ------------------------------------------------------
...
# PURPOSE       : Helper package for the refactored docstring inserter backend
# EXPORTS       : none
# DEPENDS ON    : none
# REFACTOR DATE : 2026-05-02
# ------------------------------------------------------
"""Helper package for the refactored docstring inserter backend."""
