# project-path: kanda_reasoner_app/routing_signal_scorer/ml_advisory_signal/_passive_visibility_activation_models.py
"""Models for read-only advisory panel passive visibility activation."""
