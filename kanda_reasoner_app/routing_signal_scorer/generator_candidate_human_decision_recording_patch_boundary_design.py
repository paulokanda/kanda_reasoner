...
It follows the human decision recording patch design and defines the boundary for a
...
GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_FEATURE_ID = "routing_signal_scorer_v3_generator_candidate_human_decision_recording_patch_boundary_design_v1"
GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_SCHEMA_VERSION = "3.38-generator-candidate-human-decision-recording-patch-boundary-design"
GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_STATUS = (
    "generator_candidate_human_decision_recording_patch_boundary_design_schema_only_no_decision_write_no_patch_creation_no_candidate_patch_no_generator_authorization"
)
...
REQUIRED_FIELDS = frozenset(
    {
        ...
        "schema_version",
        "schema_status",
        "declared_generator_candidate_human_decision_recording_patch_boundary_design_schema_only",
        "human_decision_recording_patch_boundary_design_scope",
        "current_human_decision_recording_patch_boundary_design_state",
        "current_human_decision_recording_patch_boundary_design_effect",
        "current_recorded_decision_value",
        "required_prior_milestones",
        "required_future_patch_evidence",
        "allowed_future_patch_actions",
        "allowed_patch_boundary_design_outputs",
        "prohibited_patch_boundary_design_outputs",
        "disabled_flags",
        "no_authority_assertions",
        "patch_boundary_design_effect_policy",
        "stop_conditions",
    }
)

REQUIRED_SCOPE = "generator_candidate_human_decision_recording_patch_boundary_design_schema_only"
ALLOWED_CURRENT_STATES = frozenset(
    {
        "decision_recording_patch_boundary_design_not_open",
...
REQUIRED_PRIOR_MILESTONES = frozenset(
    {
        "generator_candidate_human_decision_recording_patch_design_frozen",
...
REQUIRED_FUTURE_PATCH_EVIDENCE = frozenset(
    {
        ...
        "decision_scope",
        "referenced_human_decision_recording_patch_design_freeze_id",
        ...
        "patch_boundary_design_has_no_write_effect_acknowledged",
...
ALLOWED_FUTURE_PATCH_ACTIONS = frozenset(
    {
        "review_decision_recording_patch_boundary_design_only",
...
REQUIRED_ALLOWED_PATCH_BOUNDARY_DESIGN_OUTPUTS = frozenset(
    {
        "human_decision_recording_patch_boundary_design_schema",
        "future_recording_patch_evidence_checklist",
        "future_recording_patch_required_fields",
        "allowed_future_patch_actions",
        "current_not_recorded_notice",
        "current_patch_boundary_design_not_open_notice",
...
REQUIRED_PROHIBITED_PATCH_BOUNDARY_DESIGN_OUTPUTS = frozenset(
    {
...
FORBIDDEN_FIELDS = REQUIRED_PROHIBITED_PATCH_BOUNDARY_DESIGN_OUTPUTS.union(
    {
...
def build_generator_candidate_human_decision_recording_patch_boundary_design_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "schema_status": GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_STATUS,
        "declared_generator_candidate_human_decision_recording_patch_boundary_design_schema_only": True,
        "human_decision_recording_patch_boundary_design_scope": REQUIRED_SCOPE,
        "current_human_decision_recording_patch_boundary_design_state": "decision_recording_patch_boundary_design_not_open",
        "current_human_decision_recording_patch_boundary_design_effect": "no_effect_schema_only_decision_recording_patch_boundary_design_not_open",
        ...
        "allowed_patch_boundary_design_outputs": sorted(REQUIRED_ALLOWED_PATCH_BOUNDARY_DESIGN_OUTPUTS),
        "prohibited_patch_boundary_design_outputs": sorted(REQUIRED_PROHIBITED_PATCH_BOUNDARY_DESIGN_OUTPUTS),
        ...
        "patch_boundary_design_effect_policy": "schema_only_no_decision_write_no_patch_creation_no_generator_authorization_no_runtime_effect",
...
def validate_generator_candidate_human_decision_recording_patch_boundary_design_contract(candidate: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if candidate.get("schema_id") != GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_FEATURE_ID:
        errors.append("schema_id mismatch")
    if candidate.get("schema_version") != GENERATOR_CANDIDATE_HUMAN_DECISION_RECORDING_PATCH_BOUNDARY_DESIGN_SCHEMA_VERSION:
        errors.append("schema_version mismatch")
    if candidate.get("human_decision_recording_patch_boundary_design_scope") != REQUIRED_SCOPE:
        errors.append("scope mismatch")
    if candidate.get("current_human_decision_recording_patch_boundary_design_state") not in ALLOWED_CURRENT_STATES:
        errors.append("invalid current_human_decision_recording_patch_boundary_design_state")
    ...
    required_checks = (
        ...
        ("allowed_patch_boundary_design_outputs", REQUIRED_ALLOWED_PATCH_BOUNDARY_DESIGN_OUTPUTS),
        ("prohibited_patch_boundary_design_outputs", REQUIRED_PROHIBITED_PATCH_BOUNDARY_DESIGN_OUTPUTS),
    ...
    return {
        ...
        "current_human_decision_recording_patch_boundary_design_state": candidate.get("current_human_decision_recording_patch_boundary_design_state"),
        "current_recorded_decision_value": candidate.get("current_recorded_decision_value"),
        "human_decision_recording_subchain_closed": ok,
        "real_human_decision_recorded_by_human_decision_recording_patch_boundary_design": False,
        "human_decision_write_performed": False,
        "human_decision_commit_performed": False,
        "human_decision_finalization_performed": False,
        "human_decision_recording_patch_boundary_design_created": False,
        ...
        "requires_prior_generator_candidate_human_decision_recording_patch_design": True,
...
def classify_generator_candidate_human_decision_recording_patch_boundary_design_request(action: str) -> dict[str, Any]:
    ...
    return {
        ...
        "permitted_output": "human_decision_recording_patch_boundary_design_schema" if review_only and not denied else None,
        "current_recorded_decision_value": "not_recorded",
        "real_human_decision_recorded_by_human_decision_recording_patch_boundary_design": False,
        "human_decision_write_performed": False,
        "human_decision_commit_performed": False,
