# project-path: kanda_reasoner_app/routing_signal_scorer/_generator_candidate_dependency_boundary_constants.py
"""Constants for generator candidate dependency boundary contracts."""
