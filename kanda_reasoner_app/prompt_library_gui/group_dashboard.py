...
_COLOR_STYLES = {
    ...
    "indigo": ("#5f6fd1", "#36458f", "#94a0ec", "#f0f2ff", "#273064"),
    "cyan": ("#3f9fbd", "#256a81", "#78c7dd", "#edfaff", "#164555"),
    "pink": ("#c36892", "#8b3d61", "#e39cbb", "#fff0f6", "#5d2440"),
    "lime": ("#7fa54a", "#526f2b", "#aed078", "#f4faea", "#354919"),
