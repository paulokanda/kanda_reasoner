...
# Support package import and direct script execution by path.
if __package__ in (None, ""):
    import sys as _workflow_bootstrap_sys
    from pathlib import Path as _WorkflowBootstrapPath

    _WORKFLOW_PROJECT_ROOT = _WorkflowBootstrapPath(__file__).resolve().parents[2]
    _WORKFLOW_PROJECT_ROOT_TEXT = str(_WORKFLOW_PROJECT_ROOT)
    if _WORKFLOW_PROJECT_ROOT_TEXT not in _workflow_bootstrap_sys.path:
        _workflow_bootstrap_sys.path.insert(0, _WORKFLOW_PROJECT_ROOT_TEXT)
    __package__ = "kanda_reasoner_app.manage_workflows"

    del _WorkflowBootstrapPath
    del _WORKFLOW_PROJECT_ROOT
    del _WORKFLOW_PROJECT_ROOT_TEXT
    del _workflow_bootstrap_sys
