# project-path: kanda_reasoner_app/reasoner_context_collector/collector_widget_registry_validate_manifests.py
"""Validate collector_widget_registry helper manifest artifacts."""
...
BASE = ROOT / _STAGED_PACKAGE_NAME / "reasoner_context_collector"
ORIGIN = BASE / "collector_widget_registry.py"
HELP_DIR = BASE / "collector_widget_registry_help"
MANIFEST = BASE / "collector_widget_registry_help.json"
...
def main() -> int:
    ...
    if errors:
        for error in errors:
            print("FAIL " + error)
        return 1
    print("PASS collector_widget_registry helper manifest")
    return 0
