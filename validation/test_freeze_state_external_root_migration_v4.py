...
def remove_isolated_show_root_for_fixture(project_root: Path) -> None:
    """Remove a fixture show-project root before tests that require a clean start."""
    ...
    assert_true(show_root.parent == project_root.parent, "refusing to clean show-project root outside fixture parent")
    if show_root.exists():
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("VALIDATION OK: freeze-state-external-root-migration-v4")
