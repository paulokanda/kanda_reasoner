...
"""Validate startup artifact read-order guard v6."""
...
def main() -> int:
    ...
    require("CANONICAL_HELPERS = r\n" not in generator_text, "Broken v5 helper assignment remains in generator.")
    ...
    require("# STARTUP_ARTIFACT_READ_ORDER_GUARD_V6 canonical helpers" in generator_text, "Generator does not contain v6 canonical helpers.")
    ...
    print("VALIDATION OK: startup-artifact-read-order-guard-v6")
