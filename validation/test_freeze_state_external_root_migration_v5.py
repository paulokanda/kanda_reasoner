...
FIXTURE_PROJECT_PREFIX = "kanda_v5_fixture_"
...
def remove_isolated_show_root_for_fixture(project_root: Path) -> None:
    ...
    is the generated fixture name: it must start with kanda_v5_fixture_ and end
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("VALIDATION OK: freeze-state-external-root-migration-v5")
