# project-path: validation/test_architecture_review_large_file_refactor_batch_queue_install_repair_v3.py
"""Regression tests for batch queue install repair v3."""
...
class BatchQueueInstallRepairV3Tests(unittest.TestCase):
    """Validate self-healing install/validate contract and no-write gates."""

    def test_all_batch_queue_validators_are_installed(self) -> None:
        """The repair must install v1, v2, and v3 validators under tools/."""
    ...
    def test_batch_queue_still_writes_only_daily_work_evidence(self) -> None:
