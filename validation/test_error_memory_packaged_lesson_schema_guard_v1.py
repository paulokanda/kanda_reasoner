#!/usr/bin/env python3
"""Validate Error Memory packaged lesson schema guard v1."""
...
FEATURE_ID = "error-memory-packaged-lesson-schema-guard-v1"
...
def main() -> int:
    ...
    require(PIR_MARKER in read_text(pir), "patch error register entry missing")
