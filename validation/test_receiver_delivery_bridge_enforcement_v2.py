"""Validate receiver delivery bridge enforcement v2."""
...
FEATURE_ID = "receiver-delivery-bridge-enforcement-v2"
PATCH_NAME = "kanda_receiver_delivery_bridge_enforcement_v2_patch"
...
Changed files: scripts/validate_ai_response_patch_delivery.py; validation/test_receiver_delivery_bridge_enforcement_v2.py
...
python validation\test_receiver_delivery_bridge_enforcement_v2.py
python scripts\validate_patch_zip.py E:\kanda_reasoner_delete_after_daily_work\kanda_receiver_delivery_bridge_enforcement_v2_patch.zip
Write-Host "VALIDATION OK: receiver-delivery-bridge-enforcement-v2"
...
def _error_memory_lesson(redaction: object | None = None) -> str:
    lesson = {
        ...
        "created_at_utc": "2026-06-28T04:30:00Z",
        "updated_at_utc": "2026-06-28T04:30:00Z",
        "source_patch_zip": "kanda_receiver_delivery_bridge_enforcement_v2_patch.zip",
        "raw_error_text": "test",
        ...
        "exception": {
            "type": "TestError",
            "phase": "validation",
            "relative_file_path": "validation/test_receiver_delivery_bridge_enforcement_v2.py",
        ...
        "fingerprint": {
            ...
            "components": ["test"],
            "fingerprint_hash": "test_receiver_v2",
        },
        ...
        "regression_check": {
            ...
            "command": "python validation/test_receiver_delivery_bridge_enforcement_v2.py",
            "expected_marker": "VALIDATION OK: receiver-delivery-bridge-enforcement-v2",
            "required_before_freeze": True,
        },
        "validation_command_summary": "Run validation.",
        "validation_evidence": ["VALIDATION OK: receiver-delivery-bridge-enforcement-v2", "STATUS: IN_SYNC"],
...
''' + _freeze_form("VALIDATION OK: receiver-delivery-bridge-enforcement-v2") + r'''
...
def main() -> int:
    ...
    print("VALIDATION OK: receiver-delivery-bridge-enforcement-v2")
