"""Validate startup artifact read-order guard v2."""
...
FEATURE_ID = "startup-artifact-read-order-guard-v2"
...
def main() -> int:
    ...
    require(sorted_names[:4] == expected_files, "Generated file sort order is not expected: " + str(sorted_names[:4]))
    ...
    print("VALIDATION OK: startup-artifact-read-order-guard-v2")
