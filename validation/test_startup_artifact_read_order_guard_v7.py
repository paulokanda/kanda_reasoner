"""Validate startup artifact read-order guard v7."""
...
def main() -> int:
    ...
    require("CANONICAL_HELPERS = r\n" not in generator_text, "Broken helper assignment remains in generator.")
    ...
    require("# STARTUP_ARTIFACT_READ_ORDER_GUARD_V7 canonical helpers BEGIN" in generator_text, "Generator does not contain v7 canonical helpers.")
    ...
    print("VALIDATION OK: startup-artifact-read-order-guard-v7")
